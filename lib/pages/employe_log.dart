...
class EmployeeLog extends StatefulWidget {
  @override
  _EmployeeLogState createState() => _EmployeeLogState();
}
...
class _EmployeeLogState extends State<EmployeeLog> {
  ...
  Future logIn() async{
    String url = "https://dentaldb.000webhostapp.com/API/emplyelog.php";
    ...
    if(dataUsers.length == 1){
      //goto homepage
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>EmployeProfile()));
    }else{
